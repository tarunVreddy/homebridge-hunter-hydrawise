 ...
 * permits empty functions when the body intent is documented in the name) and so the same reference is shared by every method - micro-optimization, but it
 * also makes silentLog cheap to instantiate per test.
 */
function noop(): void {
