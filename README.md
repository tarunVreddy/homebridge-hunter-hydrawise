...
[![homebridge-hunter-hydrawise-matter: Native HomeKit & Matter support for Hunter Hydrawise](https://raw.githubusercontent.com/tarunVreddy/homebridge-hunter-hydrawise-matter/main/images/homebridge-hunter-hydrawise.svg)](https://github.com/tarunVreddy/homebridge-hunter-hydrawise-matter)

# Homebridge Hunter Hydrawise (Matter)

[![Downloads](https://img.shields.io/npm/dt/homebridge-hunter-hydrawise-matter?color=%230A6E93&logo=icloud&logoColor=%23FFFFFF&style=for-the-badge)](https://www.npmjs.com/package/homebridge-hunter-hydrawise-matter)
[![Version](https://img.shields.io/npm/v/homebridge-hunter-hydrawise-matter?color=%230A6E93&label=Homebridge%20Hunter%20Hydrawise%20Matter&logoColor=%23FFFFFF&style=for-the-badge&logo=rainmeter)](https://www.npmjs.com/package/homebridge-hunter-hydrawise-matter)
...
`homebridge-hunter-hydrawise-matter` is a [Homebridge](https://homebridge.io) plugin that makes your Hunter Hydrawise irrigation controller available to [Apple's](https://www.apple.com) [HomeKit](https://www.apple.com/ios/home) smart home platform. It also supports [Matter](https://csa-iot.org/all-solutions/matter/), enabling cross-platform compatibility with **Amazon Alexa**, **Google Home**, and other Matter-compatible ecosystems.

> **Note:** This plugin is a fork of the excellent [homebridge-hunter-hydrawise](https://github.com/hjdhjd/homebridge-hunter-hydrawise) plugin originally created by [HJD](https://github.com/hjdhjd). This fork diverges from the original project specifically to implement deep, native Homebridge v2 Matter support for Hydrawise controllers. 
...
To get started with `homebridge-hunter-hydrawise-matter`:

  * [Generate a Hydrawise API key](https://app.hydrawise.com/config/account-details), should you need one.</li>
  * Install `homebridge-hunter-hydrawise-matter` using the Homebridge webUI. Make sure you make `homebridge-hunter-hydrawise-matter` a child bridge for the best experience.
  * Configure `homebridge-hunter-hydrawise-matter` and enter your API key.
  * That's it. Enjoy!
...
[![License](https://img.shields.io/npm/l/homebridge-hunter-hydrawise-matter?color=%230A6E93&logo=open%20source%20initiative&logoColor=%23FFFFFF&style=for-the-badge)](https://github.com/tarunVreddy/homebridge-hunter-hydrawise-matter/blob/main/LICENSE.md)
[![Build Status](https://img.shields.io/github/actions/workflow/status/tarunVreddy/homebridge-hunter-hydrawise-matter/ci.yml?branch=main&color=%230A6E93&logo=github-actions&logoColor=%23FFFFFF&style=for-the-badge)](https://github.com/tarunVreddy/homebridge-hunter-hydrawise-matter/actions?query=workflow%3A%22Continuous+Integration%22)
[![Dependencies](https://img.shields.io/librariesio/release/npm/homebridge-hunter-hydrawise-matter?color=%230A6E93&logo=dependabot&style=for-the-badge)](https://libraries.io/npm/homebridge-hunter-hydrawise-matter)
[![GitHub commits since latest release (by SemVer)](https://img.shields.io/github/commits-since/tarunVreddy/homebridge-hunter-hydrawise-matter/latest?color=%230A6E93&logo=github&sort=semver&style=for-the-badge)](https://github.com/tarunVreddy/homebridge-hunter-hydrawise-matter/commits/main)
